    ...
    <div id="contentWrapper">
      ...
      <!--start innercontent-->
        ...
        <!--start main content-->
          ...
          <?php $is_mediagallery_detail = FALSE; ?>
          <?php if ((arg(0) !== NULL) && (arg(1) !== NULL)): ?>
	    <?php if ((arg(0) === 'media-gallery') && (arg(1) === 'detail')): ?>
	      <?php $is_mediagallery_detail = TRUE; ?>
	    <?php endif; ?>
          <?php endif; ?>

          <?php if (!$is_mediagallery_detail): ?>
	    <?php if ($title): ?>
